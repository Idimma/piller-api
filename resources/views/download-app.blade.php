    ...
    <div id="layoutDefault_content">
        <main>
                            ...
                            <li class="nav-item dropdown no-caret">
                                ...
                                <div class="dropdown-menu dropdown-menu-right animated--fade-in-up"
                                    ...
                                    >
                                        ...
                                        <div>
                                            <div class="small text-gray-500">iPhone</div>
                                            Requires Apple iOS 9.3+
                                        </div>
                                    </a
                                    >
                                </div>
                        ...
                        <div class="row justify-content-center align-items-center">
                            <div class="col-lg-6" data-aos="fade-right">
                                ...
                                <div class="mb-5 mb-lg-0">
                                    ...
                                    <div class="page-header-text mt-2 text-xs font-italic">* Requires Android OS 4.3+ or
                                        Apple iOS 9.3+
                                    </div>
                                </div>
                            </div>
            ...
            <section class="bg-white py-10">
                <div class="container">
                    <h1 class="text-center my-5">App Features</h1>
                    <div class="row text-center">
                        <div class="col-lg-4 mb-5 mb-lg-0">
                            ...
                            <p class="mb-0">Easy to use online payment dashboard</p>
                        </div>
                        <div class="col-lg-4 mb-5 mb-lg-0">
                            <div class="icon-stack icon-stack-xl bg-gradient-primary-to-secondary text-white mb-4"><i
            ...
            {{--                                    <h5>Utilities</h5>--}}
            {{--                                    <p class="card-text small">Powerful utility classes makes it easy to customize your--}}
            {{--                                        product.</p>--}}
            {{--                                </div>--}}
            {{--                            </a--}}
            {{--                            >--}}
