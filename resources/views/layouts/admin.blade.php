...
<head>
    ...
    <title>{{ config('app.name', 'Cititasker') }}</title>
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Nav Item - Dashboard -->
        <li class="nav-item {{ linkActive('posters') }}">
            <a class="nav-link" href="{{ route('posters') }}">
                <i class="fas fa-fw fa-users"></i>
                <span>{{ __('Posters') }}</span>
            </a>
        </li>
        <!-- Nav Item - Dashboard -->
        <li class="nav-item {{ linkActive('taskers') }}">
            <a class="nav-link" href="{{ route('taskers') }}">
                <i class="fas fa-fw fa-users-cog"></i>
                <span>{{ __('Taskers') }}</span></a>
        </li>
        <!-- Nav Item - Dashboard -->
